...
// Get DOM elements for displaying location and results
...
const proceedWithLocation = (userLat, userLon) => {
  ...
  const restaurantWithDistance = restaurantWithLocation.map((restaurant) => {
    ...
    // Extract longitude and latitude from restaurant coordinates
  ...
  // Sort restaurant by distance (nearest first)
  restaurantWithDistance.sort((a, b) => a.distance - b.distance);

  console.log('With distance:', restaurantWithDistance);
...
function getLocation() {
  ...
  function error() {
    ...
    proceedWithLocation(60.1699, 24.9455); //Use Helsinki center coordinates as fallback
  }
}
